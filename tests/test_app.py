...
def test_register_student():
    ...
    data = response.json()
    assert "id" in data
    assert data["roll_no"] == "RN-2026-BROWN"
...
def test_list_and_get_students():
    # Register first
    reg = client.post("/register", json={"roll_no": "RN-101", "name": "Alice", "email": "alice@cybage.com", "contact_no": "+91 9876543210", "gender": "Female", "city": "Seattle", "country": "USA", "pincode": "98101", "course": "DevOps"})
...
def test_delete_student():
    reg = client.post("/register", json={"roll_no": "RN-102", "name": "Bob", "email": "bob@cybage.com", "contact_no": "+1 555-0188", "gender": "Male", "city": "Chicago", "country": "USA", "pincode": "60601", "course": "Cloud Native"})
    student_id = reg.json()["id"]
