...
def test_list_and_get_students():
    # Register first
    reg = client.post("/register", json={"name": "Alice", "email": "alice@cybage.com", "course": "DevOps"})
...
def test_delete_student():
    reg = client.post("/register", json={"name": "Bob", "email": "bob@cybage.com", "course": "Cloud Native"})
    student_id = reg.json()["id"]
